 ...
 */
final class Version20230121152020 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE medias ADD CONSTRAINT FK_12D2AF816BF700BD FOREIGN KEY (status_id) REFERENCES roles (id)');
